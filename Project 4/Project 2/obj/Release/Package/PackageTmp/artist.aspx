...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:disk_inventory %>" DeleteCommand="UPDATE [Disk] SET [Disk].[artist_ID] = NULL WHERE [Disk].[artist_ID] = @artist_ID
DELETE FROM [Artist] WHERE [Artist].[artist_ID] = @artist_ID" InsertCommand="INSERT INTO [Artist] ([artistfName], [artistlName], [groupName]) VALUES (@artistfName, @artistlName, @groupName)" SelectCommand="SELECT [artist_ID], [artistfName], [artistlName], [groupName] FROM [Artist]" UpdateCommand="UPDATE [Artist] SET [artistfName] = @artistfName, [artistlName] = @artistlName, [groupName] = @groupName WHERE [artist_ID] = @artist_ID">
			<DeleteParameters>
