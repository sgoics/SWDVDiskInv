...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:ValidationSummary ID="ValidationSummary1" ValidationGroup="edit" runat="server" HeaderText="* means that this field is required" CssClass="text-danger"></asp:ValidationSummary>
       ...
       <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ValidationGroup="edit" runat="server" ControlToValidate="lastName" CssClass="text-danger">*</asp:RequiredFieldValidator>
		...
		<br />
		<br />
		<asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" HorizontalAlign="Center" AllowPaging="True" AutoGenerateColumns="False" ValidationGroup="edit" DataKeyNames="borrower_ID" Width="662px">
			...
			<Columns>
				...
				<asp:TemplateField HeaderText="First Name" SortExpression="borrowerfName">
					<EditItemTemplate>
						<asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("borrowerfName") %>'></asp:TextBox>
						<asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" Text="*" ErrorMessage="Please enter first name." ControlToValidate="TextBox2" ValidationGroup="edit"></asp:RequiredFieldValidator>
					</EditItemTemplate>
					<ItemTemplate>
						<asp:Label ID="Label1" runat="server" Text='<%# Bind("borrowerfName") %>'></asp:Label>
					</ItemTemplate>
				</asp:TemplateField>
				<asp:TemplateField HeaderText="Last Name" SortExpression="borrowerlName">
					<EditItemTemplate>
						<asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("borrowerlName") %>'></asp:TextBox>
						<asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" Text="*" ErrorMessage="Please enter first name." ControlToValidate="TextBox2" ValidationGroup="edit"></asp:RequiredFieldValidator>
					</EditItemTemplate>
					<ItemTemplate>
				...
				<asp:TemplateField HeaderText="Phone Number" SortExpression="borrower_phone_number">
					<EditItemTemplate>
						...
						<asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" Text="*" ErrorMessage="Please enter a valid number." ControlToValidate="TextBox3" ValidationGroup="edit"></asp:RequiredFieldValidator>
						 <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server"  CssClass="text-danger" ControlToValidate="TextBox3" ValidationExpression="^([0-9\(\)\/\+ \-]*)$">Use this format: 9999999999</asp:RegularExpressionValidator>
					</EditItemTemplate>
					<ItemTemplate>
		...
		<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:disk_inventory %>" 
			...
			SelectCommand="SELECT [borrower_ID], [borrowerfName], [borrowerlName], [borrower_phone_number] FROM [borrower]" 
